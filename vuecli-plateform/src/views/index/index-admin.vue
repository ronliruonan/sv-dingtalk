<template>
  <div class="index-admin">
    <div class="admin">
      <img class="admin-image" :src="whImage">
      <div class="admin-hello">{{wh}}</div>
      <div class="admin-edit" v-if="userInfo.isAdmin" @click="openAdmin">编辑分组</div>
    </div>
  </div>
</template>
  ...
  methods: {
    openAdmin: function() {
      if (lock) {
        lock = false;
        const adminUrl =
          "https://h5.dingtalk.com/industry_versatility/get.html?dd_progress=false&corpId=" +
          this.corpId;
    ...
    updateName: function() {
      ...
      if (name) {
        if (dateTime >= 5 && dateTime <= 12) {
          ...
          this.whImage =
            "https://gw.alicdn.com/tps/TB1ubtjOFXXXXbzXpXXXXXXXXXX-36-36.jpg";
          ...
          this.whImage =
            "https://gw.alicdn.com/tps/TB15FNwOFXXXXbqXXXXXXXXXXXX-36-36.jpg";
        }
      }
    }
  }
